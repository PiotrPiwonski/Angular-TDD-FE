...
describe('AppComponent', () => {
  ...
  const setup =async () => {
    await TestBed.configureTestingModule({
      // imports: [AppModule, RouterTestingModule.withRoutes(routes)] - nie polecane
      declarations: [
        AppComponent,
        SignUpComponent,
        HomeComponent,
  ...
  describe('Routing', () => {
    ...
    //   it(`displays ${visiblePage} after clicking ${clickingTo} link`,
    //     async () => {
  ...
  describe('Login', () => {
    ...
    it('displays Logout link on nav bar after successful login',
      async () => {
        await setupLogin();
        const logoutLink = appComponent
          .querySelector('span[title="Logout"]') as HTMLAnchorElement;
    ...
    it('displays layout of logged in user', async () => {
      ...
      fixture.detectChanges();
      const myProfileLink = appComponent
        .querySelector('a[title="My Profile"]');
      expect(myProfileLink).toBeTruthy();
    });

    it('displays Login and Sign Up after clicking Logout',
      async () => {
      await setupLogin();
      const logoutLink = appComponent
        .querySelector('span[title="Logout"]') as HTMLSpanElement;
      logoutLink.click();
      fixture.detectChanges();
        const loginLink = appComponent
          .querySelector('a[title="Login"]') as HTMLAnchorElement;
