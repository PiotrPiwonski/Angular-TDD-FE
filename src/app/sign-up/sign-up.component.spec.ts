...
describe('SignUpComponent', () => {
  ...
  describe('Validation', () => {
    it('displays Username is required message when username is null',
      ...
      const signUp = fixture.nativeElement as HTMLElement;
      expect(signUp
        .querySelector('div[data-testid="username-validation"]')).toBeNull();
      const usernameInput = signUp
          .querySelector('input[id="username"]') as HTMLInputElement;
      ...
      const validationElement = signUp
        .querySelector('div[data-testid="username-validation"]');
    ...
    it('displays length error when username is less than 4 characters',
      () => {
        ...
        expect(validationElement?.textContent)
          .toContain('Username must be at least 4 characters long');
    });
  });
